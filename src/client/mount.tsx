...
import { UsageDashboard } from './panel/UsageDashboard.tsx'
 ...
 */
export function mountPanel(controller: PanelController, store: UsageStore): () => void {
  ...
  const ensure = (): void => {
    ...
    root.render(<UsageDashboard controller={controller} store={store} />)
  }
