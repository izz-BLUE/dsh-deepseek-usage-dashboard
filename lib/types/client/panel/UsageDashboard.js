...
function EstimateCard(props) {
    ...
    return (_jsxs("div", { className: css.estimateCard, children: [_jsx("span", { className: css.estimateValue, children: formatAmount(estimate.total, estimate.currency) }), badge !== null
                ...
                : null, _jsx("span", { className: css.estimateProvenance, title: metaTitle, children: pricingProvenance(data, t) }), scheduleIdsUsed.length > 1
...
function pricingProvenance(data, t) {
    ...
    // The plugin's windows are always Asia/Shanghai; older payloads simply
    // omit the field, so fall back instead of interpolating `undefined`.
