...
export declare const zh: {
    ...
    'panel.pricingModeLegacy': string;
    'panel.pricingNow': string;
    'panel.timezoneBeijing': string;
    'panel.pricingMultiple': string;
    'panel.pricingTimezone': string;
    'panel.currentBandOffPeak': string;
    'panel.currentBandPeak': string;
    'panel.currentBandAllDay': string;
    'panel.currentWindow': string;
    'panel.currentRates': string;
    'panel.offPeakHalfNote': string;
    'panel.windowsTooltip': string;
    'panel.bandBreakdownLabel': string;
    'panel.bandCostRow': string;
    'panel.bandCostTokens': string;
    ...
    'settings.pricingMode': string;
    'settings.pricingModeLegacy': string;
