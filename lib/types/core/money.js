...
export const MICRO_SCALE = 1000000n;
/**
 ...
 */
export function priceToMicroPerMillion(pricePerMillion) {
 ...
 * sub-micro fraction.
 */
export function tokensCostMicro(tokens, pricePerMillion) {
...
export function formatMicro(value, decimals = 4) {
    if (decimals < 0 || decimals > 9)
        throw new Error(`deepseek-usage: bad decimals ${decimals}`);
...
export function formatMicroCompact(value) {
