	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"panel.pricingModeLegacy": "旧版价格 · {date}",
			...
			"settings.pricingModeLegacy": "旧版价格表（prices，全天统一价）",
			"settings.pricingModeSchedules": "分时段价格计划（pricingSchedules，按请求时间计价）",
		...
		const en = {
			...
			"panel.pricingModeLegacy": "Legacy · {date}",
			...
			"settings.pricingModeLegacy": "Legacy price table (prices, all-day flat rates)",
			"settings.pricingModeSchedules": "Time-aware pricing schedules (pricingSchedules, priced at request time)",
		...
		*/
		...
		function pricingProvenance(data, t) {
			...
			return t("panel.pricingModeSchedules", { date: data.prices.schedules.find((item) => item.id === scheduleId)?.effectiveFrom.slice(0, 10) ?? "--" });
		}
		/**
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
								...
								children: [
									...
									data.estimatedCost.unpricedRequestCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: dashboard_module_css_default.estimateUnpriced,
										role: "status",
										children: [
											t("panel.unpriced"),
											" · ",
											t("panel.unpricedDetail", { count: data.estimatedCost.unpricedRequestCount })
										]
									}) : null,
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: settings_card_module_css_default.hint,
								children: state.pricingMode === "schedules" ? t("settings.pricingModeSchedules") : t("settings.pricingModeLegacy")
							}),
							state.pricingMode === "schedules" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
									...
									children: state.pricingSchedules.map((schedule) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [
										schedule.id,
										" · ",
