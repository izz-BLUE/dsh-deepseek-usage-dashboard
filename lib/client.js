window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-usage-css:C:\Users\饭团\Documents\测试\dsh-web-ui\packages\dsh-deepseek-usage-dashboard\src\client\panel.module.css.mjs
		const css$2 = ".e5xGaa_entry{color:var(--dsw-alias-label-tertiary,inherit);cursor:pointer;font:inherit;text-align:left;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;width:100%;padding:4px 10px;font-size:12px;line-height:20px;display:flex}.e5xGaa_entry:hover{background:var(--dsw-alias-fill-hover,transparent);color:var(--dsw-alias-label-primary,inherit)}.e5xGaa_entry[data-active=true]{background:var(--dsw-alias-fill-active,var(--dsw-alias-fill-hover,transparent));color:var(--dsw-alias-label-primary,inherit)}.e5xGaa_entryIcon{flex:none;justify-content:center;align-items:center;display:inline-flex}.e5xGaa_entryLabel{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.e5xGaa_view{box-sizing:border-box;width:100%;height:100%;padding:24px;display:none;overflow:auto}html[data-dsh-usage-active=\"\"] .e5xGaa_view{display:block}html[data-dsh-usage-active=\"\"] [data-pane=conversation]>:not([data-dsh-usage-view]){display:none!important}";
		...
		var panel_module_css_default = {
			"entry": "e5xGaa_entry",
			"entryIcon": "e5xGaa_entryIcon",
			"entryLabel": "e5xGaa_entryLabel",
			"view": "e5xGaa_view"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-usage-css:C:\Users\饭团\Documents\测试\dsh-web-ui\packages\dsh-deepseek-usage-dashboard\src\client\panel\dashboard.module.css.mjs
		const css$1 = ".AKACcG_page{box-sizing:border-box;flex-direction:column;gap:24px;width:100%;max-width:920px;margin:0 auto;display:flex}.AKACcG_header{flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:12px;display:flex}.AKACcG_title{color:var(--dsw-alias-label-primary,inherit);margin:0;font-size:20px;font-weight:600}.AKACcG_headerActions{align-items:center;gap:12px;display:flex}.AKACcG_updated{color:var(--dsw-alias-label-tertiary,inherit);font-size:12px}.AKACcG_refresh{background:var(--dsw-alias-fill-strong,transparent);color:var(--dsw-alias-label-on-strong,inherit);cursor:pointer;font:inherit;border:none;border-radius:6px;padding:4px 12px;font-size:12px;line-height:20px}.AKACcG_refresh:disabled{cursor:default;opacity:.6}.AKACcG_empty{color:var(--dsw-alias-label-tertiary,inherit);text-align:center;padding:40px 0;font-size:13px}.AKACcG_notice,.AKACcG_noticeMuted{border-radius:6px;margin:0;padding:8px 12px;font-size:12px}.AKACcG_notice{background:var(--dsw-alias-fill-warning,transparent);color:var(--dsw-alias-label-warning,inherit)}.AKACcG_noticeMuted{color:var(--dsw-alias-label-tertiary,inherit)}.AKACcG_sectionTitle{color:var(--dsw-alias-label-secondary,inherit);margin:0 0 10px;font-size:13px;font-weight:600}.AKACcG_grid{grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px;display:grid}.AKACcG_statCard{background:var(--dsw-alias-fill-subtle,transparent);border:1px solid var(--dsw-alias-stroke-default,transparent);border-radius:8px;flex-direction:column;gap:4px;padding:10px 12px;display:flex}.AKACcG_statAccent{border-color:var(--dsw-alias-stroke-strong,transparent)}.AKACcG_statLabel{color:var(--dsw-alias-label-tertiary,inherit);font-size:12px}.AKACcG_statValue{color:var(--dsw-alias-label-primary,inherit);font-variant-numeric:tabular-nums;font-size:18px;font-weight:600}.AKACcG_statHint{color:var(--dsw-alias-label-tertiary,inherit);font-size:11px}.AKACcG_cacheBar{width:100%;height:8px;margin-top:10px;display:flex;overflow:hidden}.AKACcG_cacheBarEmpty{background:var(--dsw-alias-fill-subtle,transparent);border-radius:4px;width:100%;height:100%}.AKACcG_cacheBarHit{background:var(--dsw-alias-fill-positive,var(--dsw-alias-fill-strong,#888));height:100%}.AKACcG_cacheBarMiss{background:var(--dsw-alias-fill-neutral,var(--dsw-alias-fill-strong,#ccc));height:100%}.AKACcG_twoCol{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:16px;display:grid}.AKACcG_estimateCard,.AKACcG_balanceCard,.AKACcG_trendCard{background:var(--dsw-alias-fill-subtle,transparent);border:1px solid var(--dsw-alias-stroke-default,transparent);border-radius:8px;flex-direction:column;gap:8px;padding:14px 16px;display:flex}.AKACcG_estimateValue,.AKACcG_balanceValue{color:var(--dsw-alias-label-primary,inherit);font-variant-numeric:tabular-nums;font-size:22px;font-weight:600}.AKACcG_estimateNote,.AKACcG_estimateMeta{color:var(--dsw-alias-label-tertiary,inherit);font-size:11px}.AKACcG_balanceState{color:var(--dsw-alias-label-warning,inherit);margin:0;font-size:12px}.AKACcG_balanceRows{flex-direction:column;gap:4px;margin:4px 0 0;display:flex}.AKACcG_balanceRow{justify-content:space-between;font-size:12px;display:flex}.AKACcG_balanceRow dt{color:var(--dsw-alias-label-tertiary,inherit);margin:0}.AKACcG_balanceRow dd{color:var(--dsw-alias-label-primary,inherit);font-variant-numeric:tabular-nums;margin:0}.AKACcG_trendCard{min-height:120px}.AKACcG_trend{align-items:flex-end;gap:8px;height:110px;display:flex}.AKACcG_trendCol{flex-direction:column;flex:1;min-width:0;height:100%;display:flex}.AKACcG_trendBarWrap{flex:1;justify-content:center;display:flex}.AKACcG_trendBar{background:var(--dsw-alias-fill-strong,#888);border-radius:3px 3px 0 0;width:70%;min-height:2px}.AKACcG_trendLabel{color:var(--dsw-alias-label-tertiary,inherit);text-align:center;margin-top:6px;font-size:10px}.AKACcG_footer{border-top:1px solid var(--dsw-alias-stroke-default,transparent);color:var(--dsw-alias-label-tertiary,inherit);flex-direction:column;gap:4px;padding-top:12px;font-size:11px;display:flex}";
		...
		var dashboard_module_css_default = {
			"balanceCard": "AKACcG_balanceCard",
			"balanceRow": "AKACcG_balanceRow",
			"balanceRows": "AKACcG_balanceRows",
			"balanceState": "AKACcG_balanceState",
			"balanceValue": "AKACcG_balanceValue",
			"cacheBar": "AKACcG_cacheBar",
			"cacheBarEmpty": "AKACcG_cacheBarEmpty",
			"cacheBarHit": "AKACcG_cacheBarHit",
			"cacheBarMiss": "AKACcG_cacheBarMiss",
			"empty": "AKACcG_empty",
			"estimateCard": "AKACcG_estimateCard",
			"estimateMeta": "AKACcG_estimateMeta",
			"estimateNote": "AKACcG_estimateNote",
			"estimateValue": "AKACcG_estimateValue",
			"footer": "AKACcG_footer",
			"grid": "AKACcG_grid",
			"header": "AKACcG_header",
			"headerActions": "AKACcG_headerActions",
			"notice": "AKACcG_notice",
			"noticeMuted": "AKACcG_noticeMuted",
			"page": "AKACcG_page",
			"refresh": "AKACcG_refresh",
			"sectionTitle": "AKACcG_sectionTitle",
			"statAccent": "AKACcG_statAccent",
			"statCard": "AKACcG_statCard",
			"statHint": "AKACcG_statHint",
			"statLabel": "AKACcG_statLabel",
			"statValue": "AKACcG_statValue",
			"title": "AKACcG_title",
			"trend": "AKACcG_trend",
			"trendBar": "AKACcG_trendBar",
			"trendBarWrap": "AKACcG_trendBarWrap",
			"trendCard": "AKACcG_trendCard",
			"trendCol": "AKACcG_trendCol",
			"trendLabel": "AKACcG_trendLabel",
			"twoCol": "AKACcG_twoCol",
			"updated": "AKACcG_updated"
		};
		//#endregion
		...
		function TrendChart(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: props.data.map((day) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: dashboard_module_css_default.trendCol,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		function UsageDashboard({ store }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DashboardView, {
				snapshot: (0, react.useSyncExternalStore)((listener) => store.subscribe(listener), () => store.getSnapshot()),
				onRefresh: () => {
					store.refresh();
				}
			});
		...
		*/
		...
		//#endregion
		//#region \0dsh-usage-css:C:\Users\饭团\Documents\测试\dsh-web-ui\packages\dsh-deepseek-usage-dashboard\src\client\settings\settings-card.module.css.mjs
		const css = ".oIyjZW_card{border:1px solid var(--dsw-alias-stroke-default,transparent);border-radius:8px;margin:0;list-style:none}.oIyjZW_cardOpen{border-color:var(--dsw-alias-stroke-strong,transparent)}.oIyjZW_header{cursor:pointer;font:inherit;text-align:left;background:0 0;border:none;justify-content:space-between;align-items:center;gap:8px;width:100%;padding:10px 12px;display:flex}.oIyjZW_headText{flex-direction:column;gap:2px;min-width:0;display:flex}.oIyjZW_name{color:var(--dsw-alias-label-primary,inherit);font-size:13px;font-weight:600}.oIyjZW_description,.oIyjZW_chevron,.oIyjZW_chevronOpen{color:var(--dsw-alias-label-tertiary,inherit);font-size:12px}.oIyjZW_chevronOpen{transform:rotate(180deg)}.oIyjZW_pending{background:var(--dsw-alias-fill-warning,transparent);color:var(--dsw-alias-label-warning,inherit);border-radius:4px;padding:2px 6px;font-size:11px}.oIyjZW_body{border-top:1px solid var(--dsw-alias-stroke-default,transparent);flex-direction:column;gap:10px;padding:12px;display:flex}.oIyjZW_field{flex-direction:column;gap:4px;display:flex}.oIyjZW_label{color:var(--dsw-alias-label-primary,inherit);font-size:12px;font-weight:600}.oIyjZW_hint{color:var(--dsw-alias-label-tertiary,inherit);margin:0;font-size:11px}.oIyjZW_input,.oIyjZW_select,.oIyjZW_priceInput{background:var(--dsw-alias-fill-subtle,transparent);border:1px solid var(--dsw-alias-stroke-default,transparent);color:var(--dsw-alias-label-primary,inherit);font:inherit;border-radius:6px;padding:5px 8px;font-size:12px}.oIyjZW_select{cursor:pointer}.oIyjZW_notExposed,.oIyjZW_readOnly,.oIyjZW_failed,.oIyjZW_invalid{margin:0;font-size:12px}.oIyjZW_notExposed{color:var(--dsw-alias-label-tertiary,inherit)}.oIyjZW_readOnly{color:var(--dsw-alias-label-warning,inherit)}.oIyjZW_failed,.oIyjZW_invalid{color:var(--dsw-alias-label-danger,var(--dsw-alias-label-warning,inherit))}.oIyjZW_footer{justify-content:flex-end;align-items:center;gap:8px;display:flex}.oIyjZW_save,.oIyjZW_discard,.oIyjZW_reset,.oIyjZW_addRow,.oIyjZW_removeRow{background:var(--dsw-alias-fill-subtle,transparent);border:1px solid var(--dsw-alias-stroke-default,transparent);color:var(--dsw-alias-label-primary,inherit);cursor:pointer;font:inherit;border-radius:6px;padding:3px 10px;font-size:12px;line-height:20px}.oIyjZW_save{background:var(--dsw-alias-fill-strong,transparent);color:var(--dsw-alias-label-on-strong,inherit)}.oIyjZW_save:disabled,.oIyjZW_discard:disabled,.oIyjZW_reset:disabled,.oIyjZW_addRow:disabled,.oIyjZW_removeRow:disabled{cursor:default;opacity:.5}.oIyjZW_pricesHead{align-items:center;gap:8px;display:flex}.oIyjZW_pricesHead .oIyjZW_label{flex:1}.oIyjZW_priceTable{flex-direction:column;gap:4px;display:flex}.oIyjZW_priceRow,.oIyjZW_priceRowHead{grid-template-columns:1.4fr .8fr .8fr .8fr .7fr 1fr auto;gap:4px;display:grid}.oIyjZW_priceRowHead{color:var(--dsw-alias-label-tertiary,inherit);font-size:11px}.oIyjZW_priceInput{width:100%;min-width:0}.oIyjZW_removeRow{padding:3px 8px}.oIyjZW_fallbackHint{color:var(--dsw-alias-label-tertiary,inherit);margin:0;font-size:11px}";
		...
		var settings_card_module_css_default = {
			"addRow": "oIyjZW_addRow",
			"body": "oIyjZW_body",
			"card": "oIyjZW_card",
			"cardOpen": "oIyjZW_cardOpen",
			"chevron": "oIyjZW_chevron",
			"chevronOpen": "oIyjZW_chevronOpen",
			"description": "oIyjZW_description",
			"discard": "oIyjZW_discard",
			"failed": "oIyjZW_failed",
			"fallbackHint": "oIyjZW_fallbackHint",
			"field": "oIyjZW_field",
			"footer": "oIyjZW_footer",
			"header": "oIyjZW_header",
			"headText": "oIyjZW_headText",
			"hint": "oIyjZW_hint",
			"input": "oIyjZW_input",
			"invalid": "oIyjZW_invalid",
			"label": "oIyjZW_label",
			"name": "oIyjZW_name",
			"notExposed": "oIyjZW_notExposed",
			"pending": "oIyjZW_pending",
			"priceInput": "oIyjZW_priceInput",
			"priceRow": "oIyjZW_priceRow",
			"priceRowHead": "oIyjZW_priceRowHead",
			"pricesHead": "oIyjZW_pricesHead",
			"priceTable": "oIyjZW_priceTable",
			"readOnly": "oIyjZW_readOnly",
			"removeRow": "oIyjZW_removeRow",
			"reset": "oIyjZW_reset",
			"save": "oIyjZW_save",
			"select": "oIyjZW_select"
		};
		//#endregion
