window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = ".mgirmG_page{--usage-accent:var(--dsw-alias-fill-accent,#5b7cfa);--usage-accent-strong:var(--dsw-alias-label-link,#315efb);box-sizing:border-box;flex-direction:column;gap:28px;width:100%;max-width:1120px;margin:0 auto;display:flex}.mgirmG_header{backdrop-filter:blur(12px);background:color-mix(in srgb, var(--dsw-alias-fill-subtle,currentColor) 5%, transparent);border:1px solid color-mix(in srgb, currentColor 11%, transparent);box-shadow:0 12px 36px color-mix(in srgb, currentColor 5%, transparent);border-radius:16px;flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:12px;padding:18px 20px;display:flex;position:relative;overflow:hidden}.mgirmG_header:after{background:linear-gradient(90deg, var(--usage-accent), var(--usage-accent-strong));content:\"\";opacity:.85;height:2px;position:absolute;bottom:0;left:20px;right:20px}.mgirmG_title{color:var(--dsw-alias-label-primary,inherit);align-items:center;gap:10px;margin:0;font-size:20px;font-weight:600;display:flex}.mgirmG_title:before{background:linear-gradient(135deg, var(--usage-accent), var(--usage-accent-strong));box-shadow:0 0 0 5px color-mix(in srgb, var(--usage-accent) 10%, transparent);content:\"\";border-radius:50%;width:9px;height:9px}.mgirmG_headerActions{align-items:center;gap:12px;display:flex}.mgirmG_updated{color:var(--dsw-alias-label-tertiary,inherit);font-size:12px}.mgirmG_refresh{background:linear-gradient(135deg, var(--usage-accent), var(--usage-accent-strong));box-shadow:0 4px 12px color-mix(in srgb, var(--usage-accent) 22%, transparent);color:var(--dsw-alias-label-on-strong,#fff);cursor:pointer;font:inherit;border:none;border-radius:999px;padding:5px 15px;font-size:12px;line-height:20px;transition:box-shadow .16s,transform .16s}.mgirmG_refresh:hover:not(:disabled){box-shadow:0 6px 18px color-mix(in srgb, var(--usage-accent) 30%, transparent);transform:translateY(-1px)}.mgirmG_refresh:disabled{cursor:default;opacity:.6}.mgirmG_empty{color:var(--dsw-alias-label-tertiary,inherit);text-align:center;padding:40px 0;font-size:13px}.mgirmG_notice,.mgirmG_noticeMuted{border-radius:6px;margin:0;padding:8px 12px;font-size:12px}.mgirmG_notice{background:var(--dsw-alias-fill-warning,transparent);color:var(--dsw-alias-label-warning,inherit)}.mgirmG_noticeMuted{background:color-mix(in srgb, currentColor 3%, transparent);border:1px solid color-mix(in srgb, currentColor 8%, transparent);color:var(--dsw-alias-label-tertiary,inherit);align-self:flex-start}.mgirmG_sectionTitle{color:var(--dsw-alias-label-secondary,inherit);align-items:center;gap:8px;margin:0 0 10px;font-size:13px;font-weight:600;display:flex}.mgirmG_sectionTitle:before{background:linear-gradient(180deg, var(--usage-accent), var(--usage-accent-strong));content:\"\";border-radius:999px;width:3px;height:14px}.mgirmG_grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;display:grid}.mgirmG_statCard{backdrop-filter:blur(10px);background:color-mix(in srgb, var(--dsw-alias-fill-subtle,currentColor) 5%, transparent);border:1px solid color-mix(in srgb, currentColor 10%, transparent);box-shadow:0 6px 20px color-mix(in srgb, currentColor 4%, transparent);border-radius:14px;flex-direction:column;gap:5px;min-height:78px;padding:14px 16px;transition:border-color .16s,box-shadow .16s,transform .16s;display:flex;position:relative;overflow:hidden}.mgirmG_statCard:after{background:linear-gradient(90deg, var(--usage-accent), var(--usage-accent-strong));content:\"\";opacity:0;pointer-events:none;border-radius:999px;width:auto;height:2px;transition:opacity .16s;position:absolute;inset:0 14px auto}.mgirmG_statCard:hover{border-color:color-mix(in srgb, var(--usage-accent) 28%, transparent);box-shadow:0 9px 24px color-mix(in srgb, var(--usage-accent) 10%, transparent);transform:translateY(-2px)}.mgirmG_statCard:hover:after,.mgirmG_statAccent:after{opacity:1}.mgirmG_statAccent{background:color-mix(in srgb, var(--usage-accent) 9%, transparent);border-color:color-mix(in srgb, var(--usage-accent) 28%, transparent)}.mgirmG_statPositive{border-color:color-mix(in srgb, var(--dsw-alias-fill-positive,#18a957) 26%, transparent)}.mgirmG_statDanger{background:color-mix(in srgb, var(--dsw-alias-fill-danger,#f04452) 5%, transparent);border-color:color-mix(in srgb, var(--dsw-alias-fill-danger,#f04452) 34%, transparent)}.mgirmG_statLabelRow{align-items:center;gap:7px;display:flex}.mgirmG_statIcon{border:1px solid color-mix(in srgb, currentColor 18%, transparent);box-sizing:border-box;color:var(--dsw-alias-label-tertiary,inherit);border-radius:50%;justify-content:center;align-items:center;width:15px;height:15px;font-size:9px;line-height:1;display:inline-flex}.mgirmG_statAccent .mgirmG_statIcon,.mgirmG_statAccent .mgirmG_statValue{color:var(--usage-accent-strong)}.mgirmG_statPositive .mgirmG_statIcon,.mgirmG_statPositive .mgirmG_statValue{color:var(--dsw-alias-label-positive,var(--dsw-alias-fill-positive,#18a957))}.mgirmG_statDanger .mgirmG_statIcon,.mgirmG_statDanger .mgirmG_statValue{color:var(--dsw-alias-label-danger,var(--dsw-alias-fill-danger,#f04452))}.mgirmG_statLabel{color:var(--dsw-alias-label-tertiary,inherit);font-size:12px}.mgirmG_statValue{color:var(--dsw-alias-label-primary,inherit);font-variant-numeric:tabular-nums;font-size:21px;font-weight:600}.mgirmG_statHint{color:var(--dsw-alias-label-tertiary,inherit);min-height:14px;font-size:11px}.mgirmG_cacheBar{background:color-mix(in srgb, currentColor 7%, transparent);border-radius:999px;width:100%;height:9px;margin-top:12px;display:flex;overflow:hidden}.mgirmG_cacheBarEmpty{background:var(--dsw-alias-fill-subtle,transparent);border-radius:4px;width:100%;height:100%}.mgirmG_cacheBarHit{background:linear-gradient(90deg, var(--usage-accent), var(--usage-accent-strong));height:100%}.mgirmG_cacheBarMiss{background:var(--dsw-alias-fill-neutral,var(--dsw-alias-fill-strong,#ccc));height:100%}.mgirmG_twoCol{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:18px;display:grid}.mgirmG_estimateCard,.mgirmG_balanceCard,.mgirmG_trendCard{backdrop-filter:blur(12px);background:color-mix(in srgb, var(--dsw-alias-fill-subtle,currentColor) 5%, transparent);border:1px solid color-mix(in srgb, currentColor 10%, transparent);box-shadow:0 8px 26px color-mix(in srgb, currentColor 4%, transparent);border-radius:16px;flex-direction:column;gap:8px;padding:19px 20px;display:flex;position:relative}.mgirmG_estimateCard:before,.mgirmG_balanceCard:before{background:var(--usage-accent);content:\"\";opacity:.8;border-radius:999px;width:3px;height:28px;position:absolute;top:20px;left:0}.mgirmG_estimateValue,.mgirmG_balanceValue{color:var(--usage-accent-strong);font-variant-numeric:tabular-nums;font-size:24px;font-weight:600}.mgirmG_estimateNote,.mgirmG_estimateMeta{color:var(--dsw-alias-label-tertiary,inherit);font-size:11px}.mgirmG_balanceState{color:var(--dsw-alias-label-warning,inherit);margin:0;font-size:12px}.mgirmG_balanceRows{flex-direction:column;gap:4px;margin:4px 0 0;display:flex}.mgirmG_balanceRow{justify-content:space-between;font-size:12px;display:flex}.mgirmG_balanceRow dt{color:var(--dsw-alias-label-tertiary,inherit);margin:0}.mgirmG_balanceRow dd{color:var(--dsw-alias-label-primary,inherit);font-variant-numeric:tabular-nums;margin:0}.mgirmG_trendCard{background:linear-gradient(155deg, color-mix(in srgb, var(--usage-accent) 7%, transparent), color-mix(in srgb, currentColor 2%, transparent) 60%, color-mix(in srgb, var(--usage-accent-strong) 3%, transparent));border-color:color-mix(in srgb, var(--usage-accent) 18%, transparent);padding:16px 20px 12px;overflow:hidden}.mgirmG_trend{color:var(--dsw-alias-label-tertiary,currentColor);position:relative}.mgirmG_trendChartHeader{justify-content:space-between;align-items:center;gap:14px;min-height:24px;display:flex}.mgirmG_trendChartTitle{color:var(--dsw-alias-label-secondary,inherit);font-size:12px;font-weight:500}.mgirmG_trendLegend{color:var(--dsw-alias-label-tertiary,inherit);align-items:center;gap:14px;font-size:10px;display:flex}.mgirmG_trendLegend span{align-items:center;gap:5px;display:inline-flex}.mgirmG_trendLegend i{border-radius:50%;width:7px;height:7px;display:inline-block}.mgirmG_legendTotal{background:var(--usage-accent-strong)}.mgirmG_legendAverage{background:color-mix(in srgb, currentColor 42%, transparent)}.mgirmG_trendSummary{border-top:1px solid color-mix(in srgb, currentColor 8%, transparent);justify-content:flex-end;align-items:center;gap:18px;min-height:20px;padding:10px 2px 0;display:flex}.mgirmG_trendSummary span{color:var(--dsw-alias-label-secondary,inherit);font-variant-numeric:tabular-nums;font-size:11px}.mgirmG_trendSummary strong{color:var(--dsw-alias-label-primary,inherit);margin-left:4px;font-size:13px}.mgirmG_trendSvg{width:100%;height:190px;margin-top:5px;display:block;overflow:visible}.mgirmG_trendGrid line{stroke:currentColor;stroke-dasharray:3 5;stroke-opacity:.16;stroke-width:1px;vector-effect:non-scaling-stroke}.mgirmG_trendAverageLine{stroke:currentColor;stroke-dasharray:5 5;stroke-opacity:.36;stroke-width:1.25px;vector-effect:non-scaling-stroke}.mgirmG_trendGrid text,.mgirmG_trendDate,.mgirmG_trendPointValue{fill:currentColor;font-variant-numeric:tabular-nums;font-family:inherit;font-size:9px}.mgirmG_trendDate,.mgirmG_trendPointValue{dominant-baseline:middle;text-align:center;text-anchor:middle}.mgirmG_trendPointValue{fill:var(--dsw-alias-label-primary,currentColor);font-size:10px;font-weight:600}.mgirmG_trendArea{fill:var(--usage-accent);opacity:.16}.mgirmG_trendLine{fill:none;filter:drop-shadow(0 2px 3px color-mix(in srgb, var(--usage-accent) 28%, transparent));stroke:var(--usage-accent-strong);stroke-linecap:round;stroke-linejoin:round;stroke-width:2.5px;vector-effect:non-scaling-stroke}.mgirmG_trendPoint circle,.mgirmG_trendPointLatest circle{fill:var(--dsw-alias-fill-subtle,#fff);stroke:var(--usage-accent-strong);stroke-width:2px;vector-effect:non-scaling-stroke}.mgirmG_trendPointLatest circle{fill:var(--usage-accent-strong);filter:drop-shadow(0 2px 5px color-mix(in srgb, var(--usage-accent) 40%, transparent))}.mgirmG_trendMeters{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;margin:-1px;position:absolute;overflow:hidden}@media (width<=640px){.mgirmG_trendCard{padding-inline:10px}.mgirmG_trendSvg{height:168px}.mgirmG_trendSummary{gap:10px}}.mgirmG_footer{background:color-mix(in srgb, currentColor 2%, transparent);border:1px solid color-mix(in srgb, currentColor 7%, transparent);color:var(--dsw-alias-label-tertiary,inherit);border-radius:10px;flex-direction:column;gap:4px;padding:10px 12px;font-size:11px;display:flex}@media (prefers-reduced-motion:reduce){.mgirmG_refresh,.mgirmG_statCard{transition:none}}@media (width<=820px){.mgirmG_grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media (width<=480px){.mgirmG_grid{grid-template-columns:1fr}.mgirmG_header{align-items:flex-start}}";
		...
		var dashboard_module_css_default = {
			...
			"legendAverage": "mgirmG_legendAverage",
			"legendTotal": "mgirmG_legendTotal",
			...
			"statDanger": "mgirmG_statDanger",
			"statHint": "mgirmG_statHint",
			"statIcon": "mgirmG_statIcon",
			"statLabel": "mgirmG_statLabel",
			"statLabelRow": "mgirmG_statLabelRow",
			"statPositive": "mgirmG_statPositive",
			"statValue": "mgirmG_statValue",
			"title": "mgirmG_title",
			"trend": "mgirmG_trend",
			"trendArea": "mgirmG_trendArea",
			"trendAverageLine": "mgirmG_trendAverageLine",
			"trendCard": "mgirmG_trendCard",
			"trendChartHeader": "mgirmG_trendChartHeader",
			"trendChartTitle": "mgirmG_trendChartTitle",
			"trendDate": "mgirmG_trendDate",
			"trendGrid": "mgirmG_trendGrid",
			"trendLegend": "mgirmG_trendLegend",
			"trendLine": "mgirmG_trendLine",
			"trendMeters": "mgirmG_trendMeters",
			"trendPoint": "mgirmG_trendPoint",
			"trendPointLatest": "mgirmG_trendPointLatest",
			"trendPointValue": "mgirmG_trendPointValue",
			"trendSummary": "mgirmG_trendSummary",
			"trendSvg": "mgirmG_trendSvg",
