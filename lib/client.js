	...
	factory: (require) => {
		...
		*/
		function EstimateCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					estimate.scheduleIdsUsed.length > 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		function pricingProvenance(data, t) {
			...
			const scheduleId = data.prices.currentBand?.scheduleId ?? estimate.scheduleIdsUsed[0] ?? (data.prices.schedules ?? [])[0]?.id;
