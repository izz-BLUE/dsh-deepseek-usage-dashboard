	...
	const pricesMeta = () => {
		...
		return {
			...
			currentBand: (() => {
				...
				let active;
				for (const candidate of prepared) if (candidate.effectiveMs <= now) active = candidate;
				else break;
